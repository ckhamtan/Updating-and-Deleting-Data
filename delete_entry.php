...
// Connect and select:
$dbc = mysqli_connect('localhost', 'root', 'cali1984', 'myblog');
...
print '<p sytle="color: red;">Could not delete the blog entry because:<br>' . mysqli_error($dbc) . '.</p>
<p> The query being run was: ' . $query . '</p>';
}

} else { // No ID received.

print '<p syle="color: red;">This page has been accessed in error.</p>';
} // End of main IF.
